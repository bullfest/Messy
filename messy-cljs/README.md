...
* [`src/cljs/messy_cljs/`](src/cljs/messy/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/messy/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `messy` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/messy/config.cljs) defaults to `true` in
...
```clj
(ns messy.example
  (:require [messy.config :as config])
